...
### Problem Statement Link: https://leetcode.com/problems/koko-eating-bananas/

<br/>

### Accepted 51.5K | Submissions 97.6K
<br/>
...
### Complexity Analysis
	...
	1. Time Complexity: O(NLogW), where N = piles.size(); W max(piles).
